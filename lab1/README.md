...
| Требование | Статус |
|------------|--------|
| Два Dockerfile (плохой и хороший) | ✅ |
| Минимум 3 bad practices в плохом | ✅ (8 штук) |
| Плохой Dockerfile работает | ✅ |
| Bad practices исправлены в хорошем | ✅ |
| Описание плохих практик в README | ✅ |
| Объяснение почему они плохие | ✅ |
| Описание как исправлены | ✅ |
| Две плохие практики использования контейнеров | ✅ |
| Два случая когда НЕ использовать контейнеры | ✅ |
| Монтирование volume | ✅ |
